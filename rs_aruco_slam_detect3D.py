...
def detect(save_img=False):
    ...
    config_1 = rs.config()
    config_1.enable_device('952322110770')   #serial number
    ...
    webcam = False
    depth_scale =  0.001   # L515 0.00025,  D435i 0.001
    # Directories
    ...
    for path, img, im0s, depth_image, depth_intrin in dataset:
        ...
        # Fetch pose frame
        pose = frames_1.get_pose_frame()
        if pose:
            # Print some of the pose data to the terminal
            data = pose.get_pose_data()
            #print("Frame #{}".format(pose.frame_number))
            print("Cart Position: {}".format(data.translation))
